...
const FooterLinks = () => (
  <div className="columns">
    <div className="column is-one-third" >
      ...
      <ul>
        <li>
          <a href="https://worona.org" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="https://docs.worona.org" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="https://blog.worona.org" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="https://wordpress.org/plugins/worona/" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="https://worona.org/terms" target="_blank" rel="noopener noreferrer">
    ...
    <div className="column is-one-third">
      ...
      <ul>
        <li>
          <a href="https://twitter.com/getworona" target="_blank" rel="noopener noreferrer">
